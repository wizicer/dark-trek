...
根据[性能测试](../vdf-bench/README.md)结果进行估算，作出以下假设：

- 周边潜在玩家数量：30
- 每次griffin permutation时间：40us
- 每次平方根时间：100us
- bloom filter的k=6

可得出以下结论：

- 探测所有周边玩家的每个坐标探测时间为：$30 \times (40 + 100 \times 6) = 19200$us $\approx$ 19ms

- 半径为3时的探测格子约为20个，探测时间为：$20 \times 19.2 = 384$ms
- 半径为4时的探测格子约为28个，探测时间为：$28 \times 19.2 = 537.6$ms
- 半径为5时的探测格子约为36个，探测时间为：$36 \times 19.2 = 691.2$ms
